...
final class Strings extends \Twig_Extension {
  ...
  */
  ...
  /**
    ...
    *
    * @return array Arreglo con numero de semana, año, primer dia y ultimo dia
  */
  final public static function getPrimerUltimoDiaSemana($fecha): array{
      ...
      return array('semana'=> $semana,'ano' => $year,'PrimerDia' => $primerDia,'UltimoDia'=> $ultimoDia);
  }
  //------------------------------------------------
  /**
