...
class __TwigTemplate_49e944d609365ca7077a504b94608dcc536f9e547c14e661c0e9a02358fea480 extends Twig_Template
{
            ...
            <div class=\"row\">
                <div class=\"col-md-12\">
                    <div class=\"box\">
                        ...
                        <div class=\"box-body\">
                            <div class=\"col-md-6\">
                                <label>Numero de Orden:</label><input type=\"number\" name=\"nOrden\" id=\"nOrden\" class=\"form-control\" value=\"{{ casilleros.n_orden }}\">
                            </div>
                            <div class=\"col-md-6\">
                                <label>RUT:</label><input type=\"text\" name=\"rut\" id=\"rut\" class=\"form-control\" value=\"{{ casilleros.rut }}\">
                            </div>
                            <div class=\"col-md-6\">
                                <label>Comuna:</label>
                                <select name=\"comuna\" id=\"comuna\" class=\"form-control\">
                                    {% for c in comunas %}
                                        {% if casilleros.comuna == c.id_comuna %}
                                            <option value=\"{{ c.id_comuna }}\" selected=\"selected\">{{ c.descripcion }}</option>
                                        {% else %}
                            ...
                            <div class=\"col-md-6\">
                                <label>Actividad:</label>
                                <select name=\"actividad\" id=\"actividad\" class=\"form-control\">
                                    <option value=\"{{ casilleros.actividad }}\" selected=\"selected\">{{ casilleros.actividad }}</option>
                                    <option value=\"Altas\">Altas</option>
                                    <option value=\"SSTT\">SSTT</option>
                                    <option value=\"Pet Varias\">Pet Varias</option>
                                    <option value=\"Traslados\">Traslados</option>
                            ...
                            <div class=\"col-md-6\">
                                ...
                                <select name=\"accion\" id=\"accion\" class=\"form-control\">
                                    {% for c in accion %}
                                        {% if casilleros.accion == c %}
                                            <option value=\"{{ casilleros.accion }}\" selected=\"selected\">{{ casilleros.accion }}</option>
                                        {% else %}
                                            <option value=\"{{c}}\">{{ c }}</option>
                                        {% endif %}
                                    {% endfor %}
                                </select>
                                <input type=\"hidden\" name=\"id\" id=\"id\" value=\"{{casilleros.id}}\">
                            </div>
                            <div class=\"col-md-6\">
                                <label>Casillero:</label>
                                <input type=\"text\" name=\"casillero\" id=\"casillero\" class=\"form-control\" value=\"{{casilleros.casillero}}\">
                            </div>
                            <div class=\"col-md-12\">
                                <label>Observación:</label>
                                <textarea name=\"observacion\" id=\"observacion\" cols=\"30\" rows=\"3\" class=\"form-control\">{{ casilleros.observacion }}</textarea>
                            </div>
                            <br>
                            <div class=\"col-md-12 text-center\">
                                <br>
...
{% endblock %}", "casilleros/editar_casillero.twig", "C:\\xampp\\htdocs\\helpdesk\\app\\templates\\casilleros\\editar_casillero.twig");
    }
}
